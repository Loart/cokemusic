var ROOMS = {
	...
	'studio_model_b' : {
		...
		'blocked_tiles' : [
			...
			{ 'x' : 0, 'y': 1 },
			{ 'x' : 0, 'y': 2 },
			{ 'x' : 0, 'y': 3, rightWall: true },
			{ 'x' : 1, 'y': 0 },
			{ 'x' : 1, 'y': 1 },
			{ 'x' : 1, 'y': 2 },
			{ 'x' : 1, 'y': 3, rightWall: true },
			{ 'x' : 2, 'y': 0 },
			{ 'x' : 2, 'y': 1 },
			{ 'x' : 2, 'y': 2 },
			{ 'x' : 2, 'y': 3, rightWall: true },
			{ 'x' : 3, 'y': 0, leftWall: true },
			{ 'x' : 3, 'y': 1, leftWall: true },
			{ 'x' : 3, 'y': 2, leftWall: true },
			{ 'x' : 3, 'y': 3, rightWall: true, leftWall: true },
		],
